...
const LandingPage = () => {
  return (
    <section className="text-center py-20 flex flex-col items-center">
      <h1 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-primary to-violet-500 mb-4">
      ...
      <div className="flex items-center gap-6">
          <Link 
            to="/register" 
            className="px-8 py-3 text-lg font-bold text-white bg-gradient-to-r from-primary to-violet-500 rounded-lg hover:animate-breathe"
          >
            Comece Agora
          </Link>
          <Link 
