...
import { FaEnvelope, FaCalendarAlt, FaSpinner, FaEdit, FaLock, FaExclamationTriangle, FaHeart, FaStar, FaTrophy } from 'react-icons/fa';
            ...
            <section>
                ...
                <div className="bg-zinc-800 p-8 rounded-lg border border-zinc-700 shadow-2xl shadow-primary/20">
                    ...
                    <div className="flex flex-col items-center mb-6">
                        ...
                        <h2 className="text-3xl font-bold text-gray-100 mt-4">{user.name}</h2>
